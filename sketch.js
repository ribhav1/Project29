...
function setup() {
  ...
  for(var i = 360; i <= 720; i += 40){
    block1 = new block(i,460,40,40,false,0);   
    boxes.push(block1);
  }

  for(var i = 380; i <= 700; i += 40){
    block1 = new block(i,415,40,40,false,0);   
    boxes.push(block1);
  }
  for(var i = 400; i <= 680; i += 40){
    block1 = new block(i,360,40,40,false,0);   
    boxes.push(block1);
  }
  for(var i = 420; i <= 660; i += 40){
    block1 = new block(i,315,40,40,false,0);   
    boxes.push(block1);
  }
  for(var i = 440; i <= 640; i += 40){
    block1 = new block(i,260,40,40,false,0);   
    boxes.push(block1);
  }
  for(var i = 460; i <= 620; i += 40){
    block1 = new block(i,215,40,40,false,0);   
    boxes.push(block1);
  }
  for(var i = 480; i <= 600; i += 40){
    block1 = new block(i,160,40,40,false,0);   
    boxes.push(block1);
  }
  for(var i = 500; i <= 580; i += 40){
    block1 = new block(i,115,40,40,false,0);   
    boxes.push(block1);
  }
  for(var i = 520; i <= 560; i += 40){
    block1 = new block(i,60,40,40,false,0);   
    boxes.push(block1);
  }
  for(var i = 540; i <= 540; i += 40){
    block1 = new block(i,15,40,40,false,0);   
    boxes.push(block1);
  }
